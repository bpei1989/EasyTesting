...
public class Base64Util
{
    ...
    * inserted.
    * 
    * @param encodeStr  String to be encoded.
    * 
    * @return A String with the Base64 encoded data.
    */
   public static String 
   encode(String encodeStr)
   {
      return new String(encode(encodeStr.getBytes()));
   }
    ...
    * 
    * @param decodeStr   A Base64 String to be decoded.
    * 
    ...
    */
   public static String 
   decode(String decodeStr) 
          throws IllegalArgumentException
   {
      return new String(decode(decodeStr.toCharArray()));
   }
